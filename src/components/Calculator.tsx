...
export default function Calculator(props: CalculatorProps) {
  ...
  function handleCalculatorNumberButton(e: any) {
    ...
    setCalculator((prevCalculator) => ({
      ...prevCalculator,
      display:
        prevCalculator.display === "0"
          ? number
          : prevCalculator.display + number,
    }));
  }
  ...
  function handleCalculation() {
    ...
    switch (calculator.operator) {
      case "+":
        result =
          parseFloat(calculator.firstNumber) + parseFloat(calculator.display);
        break;
      case "-":
        result =
          parseFloat(calculator.firstNumber) - parseFloat(calculator.display);
  ...
  return (
    <StyledCalculator>
      <CalculatorHeader
        ...
        themeToggleValue={props.themeToggleValue}
        header="Calc"
      />
      ...
      <StyledCalculatorbody>
        <CalculatorButton
          buttonHandler={handleCalculatorNumberButton}
          value="7"
        />
        <CalculatorButton
          buttonHandler={handleCalculatorNumberButton}
